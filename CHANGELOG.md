...
## [Unreleased]
* Add `whitelisted_tasks` for exact-name whitelisting, so allowing a task such as
  `db:migrate` no longer implies `db:migrate:reset`. Document both whitelist
  options in the README.
  [#7](https://github.com/fcpeuro/rake-ui/pull/7)
